			...
			?>
				<tr class="<?php if( ++$i % 2 ) echo "alternate" ?> tr-contacts"> 
					...
					<td class="column-author">
						...
						<strong><a href="options-general.php?page=adhc-mybama-login&wslp=users&uid=<?php echo $user_id ?>"><?php echo $user_data->user_login; ?></a></strong>

						<div class="row-actions">
							<span class="view">
								<a href="options-general.php?page=adhc-mybama-login&wslp=users&uid=<?php echo $user_id ?>"><?php _wsl_e("Profiles", 'wordpress-social-login') ?></a>
								| 
							</span>

							<span class="view">
								<a href="options-general.php?page=adhc-mybama-login&wslp=contacts&uid=<?php echo $user_id ?>"><?php _wsl_e("Contacts", 'wordpress-social-login') ?></a>
								| 
							</span>

							<span class="delete">
								<?php
									$delete_url = wp_nonce_url( 'options-general.php?page=adhc-mybama-login&wslp=users&delete=' . $user_id );
								?>
					...
					<td align="center">
						<?php
							...
							{
								?>
									<a href="options-general.php?page=adhc-mybama-login&wslp=contacts&uid=<?php echo $user_id ?>"><?php echo $counts; ?></a>
								<?php
							}
							else
							{
